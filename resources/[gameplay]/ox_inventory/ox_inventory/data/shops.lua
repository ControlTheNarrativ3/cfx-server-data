return {
	...
	DigitalDen = {
		name = 'Digital Den',
		blip = {
			id = 606, colour = 3, scale = 0.5
		}, inventory = {
			{ name = 'phone', price = 650 },
			{ name = 'wallet', price = 125 },
			{ name = 'vape', price = 75 },
			{ name = 'sim_card', price = 25 },
			
		}, locations = {
			
			vec3(393.483, -832.4572, 28.29),
		}, targets = {
			{
                ped = 'u_m_y_guido_01',
                scenario = 'WORLD_HUMAN_STAND_MOBILE_CLUBHOUSE',
                loc = vec3(393.483, -832.4572, 28.29),
                heading = 196.545,
            },
		}
	},
	...
	CoolBeans = {
		name = 'Cool Beans',
		blip = {
			id = 827, colour = 7, scale = 0.5
		}, inventory = {
			{ name = 'water', price = 13 },
			{ name = 'coffee_black', price = 14 },
			{ name = 'coffee_mocha', price = 15 },
			{ name = 'coffee_cpcno', price = 15 },
			{ name = 'coffee_amrcno', price = 16 },

			{ name = 'smore', price = 13 },
			{ name = 'donut_sby', price = 14 },
			{ name = 'donut_chc', price = 14 },
			{ name = 'icecream_vna', price = 15 },
			{ name = 'icecream_chc', price = 15 },
		...
		}, targets = {
			{
                ...
                loc = vec3(-1187.983, -1532.3014, 3.373),
                heading =  27.115,
            },
		}
	},
	...
	LDOrganics = {
		name = 'LD Organics',
		blip = {
			id = 140, colour = 69, scale = 0.5
		}, inventory = {
			{ name = 'weed_sativa', price = 150 },
			{ name = 'weed_indica', price = 150 },
			{ name = 'weed_hybrid', price = 160 },
			{ name = 'ejunk', price = 15 },
			{ name = 'ecola', price = 16 },

			{ name = 'cig_69brand', price = 13 },
			{ name = 'cig_redwood', price = 13 },
			{ name = 'cig_debonaire', price = 13 },
			

		}, locations = {
			vec3(-1172.3246, -1572.3713, 4.373),
			
		}, targets = {
			{
                ped = 'ig_lamardavis',
                scenario = 'WORLD_HUMAN_SMOKING_POT_CLUBHOUSE',
                loc = vec3(-1252.7009, -1447.7377, 3.373),
                heading = 88.4155,
            },
		}
	},
	...
	TheSeaWord = {
		name = 'The Sea Word',
		blip = {
			id = 751, colour = 15, scale = 0.5
		}, inventory = {
			{ name = 'fishingrod', price = 150 },
			{ name = 'fishbait', price = 150 }

		}, locations = {
			vec3(-1686.7527, -1072.8531, 12.1522),
			
		}, targets = {
			{
                ped = 'cs_hunter',
                scenario = 'WORLD_HUMAN_SMOKING_POT_CLUBHOUSE',
                loc = vec3(-1686.7527, -1072.8531, 12.1522),
                heading = 45.9472,
            },
		}
	},
	...
	VendingMachineDrinks = {
		...
		inventory = {
			{ name = 'water', price = 14 },
			{ name = 'ecola', price = 13 },
			{ name = 'sprunk', price = 13 },
			{ name = 'orangotang', price = 13 },
			{ name = 'ejunk', price = 15 },
		},
		model = {
