...
AddStateBagChangeHandler('VehicleProperties', "", function(bagName, _, value)
	if not value then
		return
	end
...
AddEventHandler("esx:tpm", function()
	...
	ESX.TriggerServerCallback("esx:isUserAdmin", function(admin)
		...
		if not DoesBlipExist(blipMarker) then
			ESX.ShowNotification(TranslateCap('tpm_nowaypoint'), "success", 140)
			return 'marker'
		end
		...
		if not found then
			...
			ESX.ShowNotification(TranslateCap('tpm_success'), "success", 140)
		end
...
AddEventHandler("esx:noclip", function()
	ESX.TriggerServerCallback("esx:isUserAdmin", function(admin)
		...
		ESX.ShowNotification(TranslateCap('noclip_message', noclip and Translate('enabled') or Translate('disabled')), "info", 140)
	end)
end)
