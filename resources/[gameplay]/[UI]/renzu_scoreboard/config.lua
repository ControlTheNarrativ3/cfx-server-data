...
config.toggle = true -- true = toggle, false = hold
...
config.adminfa = '<i class="fa fa-crown"></i>' -- font awsome icon to show
config.vipfa = '<i class="fa fa-star"></i>' -- fontawsome, change this whatever icon you want from fontawsome
...
config.whitelistedjobs = {
    ...
    [2] = {name = 'mechanic', fa = '<i class="fa-solid fa-gears"></i>', label = 'Mechanic'}, 
    [3] = {name = 'ambulance', fa = '<i class="fa-solid fa-truck-medical"></i>', label = 'EMS'}, 
}
